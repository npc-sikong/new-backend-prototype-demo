...
function SiteTeamsPage({ onToast }) {
  ...
  const columns = [
    { key: 'code', label: '代理部编号' }, { key: 'name', label: '代理部名称', render: (value) => <b className="ta-primary-text">{value}</b> }, { key: 'teamType', label: '代理类型', render: (_, row) => getTeamType(row) }, { key: 'mainAgent', label: '团队负责人' },
