...
export const PAGE_NOTES = {
  ...
  'master:settlement': note('代理佣金结算', '按原后台代理佣金结算未发放区域重构列表，用代理类型和代理身份替代原星级、层级两列，并支持团队代理发放佣金调整。', '代理名称、所属站点、代理类型、代理身份、返佣比例、账单类型、直属上级代理、账期范围、代理直属会员盈亏、直属会员佣金、团队代理可发放金额、调整说明和操作。', '代理类型统一为团队代理、星级代理和层级代理；团队代理身份显示团队负责人、副线负责人、独立代理或团队成员；星级代理显示几星，层级代理显示几层。团队代理操作列额外展示“修改”，可打开弹窗调整本次发放佣金；发放佣金最低可调为 0，最高不能超过团队代理可发放金额。站点账单不属于代理身份，使用横线占位。', '关联佣金方案、代理管理、团队代理管理、佣金记录和站点账单发放。', '2026-07-17 04:05：团队代理账单操作列新增“修改”，弹窗可查看团队代理可发放金额，并在 0 到可发放金额之间调整本次发放佣金。', { updatedAt: '2026-07-17 04:05' }),
