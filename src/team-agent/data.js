...
export const INITIAL_STATE = {
  ...
  agents: [
    ...
    agent({ id: '1749', account: 'dailiwc001', model: '负盈利模式', agentType: '单线代理', teamAgentType: '—', developer: 'apppay', parentId: '901', boundMemberAccount: 'M201749', email: 'dailiwc001@example.com', registeredAt: '2026-05-26 11:45', settlementMode: '独立单线', identity: '单线代理', unit: '独立单线01', lineId: 'SINGLE-001', effectiveCycle: '2026-07', site: '旺财体育', status: '启用', parent: 'apppay', subAgents: 1, members: 18, activeMembers: 46, newActiveMembers: 12, depositAmount: 214000, withdrawalAmount: 87000, totalWinLoss: 170000, validBetting: 920000, plan: '独立单线月结方案', balance: 68903.14, lastLogin: '2026-07-12 11:08' }),
...
const AGENT_SYNC_SCOPE = '本页从总控后台代理管理同名页面按代理角色同步，仅展示当前演示身份本人及授权下级范围；团队负责人查看本人团队，副线只查看本人 line_id，独立代理只查看本人单线，不展示所属站点、其他团队、审核维护字段或管理操作。'
...
function syncedRoleModule(baseKey, portal, title, extra = {}) {
  ...
  return {
    ...
    acceptance: portal === 'site'
      ...
      : '代理后台只保留一个代理管理模块；切换团队负责人、副线、独立代理后数据范围随身份变化，不出现代理收益看板、修改代理关系记录和结算周期设置。',
