...
export const PAGE_NOTES = {
  ...
  'master:plans': note('佣金方案', '按原返佣方案页面维护方案列表，在原配置中支持新增层级、星级和团队代理方案，并新增“推荐奖励”切页维护不同站点的推荐奖励方案。', '代理返佣方案字段包含序号、返佣方案名称、方案详情、创建时间、最后操作人、操作时间和操作；推荐奖励字段包含推荐奖励方案名称、适用站点、推荐人员净收益、推荐人提成百分比、预估推荐奖励、生效周期、状态和操作；新增和修改弹窗支持方案名称、站点、推荐人员净收益、提成百分比、生效周期和状态。', '团队佣金方案作为原返佣方案中的一条配置，不单独新增方案模块；新增代理方案时可选择层级代理、星级代理或团队代理。层级代理和星级代理只维护对应层级或星级的返佣比例；团队代理可维护新增活跃、活跃会员和总输赢门槛，活跃会员和新增活跃均按当前方案绑定的充值金额或有效投注门槛判定。推荐奖励按站点维护多套方案，计算公式：预估推荐奖励 = 推荐人员净收益 × 推荐人提成百分比，方案可新增、修改或删除，适配不同站点的推荐政策。', '关联代理列表、团队代理管理、代理佣金结算、推荐奖励账单和站点佣金方案。', '2026-07-17 19:12：佣金方案详情页新增“推荐奖励”切页；推荐奖励列表展示推荐人员净收益和推荐人提成百分比，支持新增、修改、删除多套站点方案，并展示预估推荐奖励。', { updatedAt: '2026-07-17 19:12' }),
