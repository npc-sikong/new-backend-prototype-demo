...
export const PAGE_NOTES = {
  ...
  'master:plans': note('佣金方案', '按原返佣方案页面维护方案列表，在原配置中支持新增层级、星级和团队代理方案，并把团队活跃判定条件绑定到具体方案。', '序号、返佣方案名称、方案详情、创建时间、最后操作人、操作时间、操作；新增和修改代理方案弹窗包含方案名称、方案类型、代理层级或星级、团队级别、新增活跃、活跃会员、总输赢、返佣比例、活跃会员判定条件、新增活跃判定条件和删除操作。', '团队佣金方案作为原返佣方案中的一条配置，不单独新增方案模块；新增代理方案时可选择层级代理、星级代理或团队代理。层级代理和星级代理只维护对应层级或星级的返佣比例，不展示团队门槛字段；团队代理可维护新增活跃、活跃会员和总输赢门槛，留空代表该条件不生效；活跃会员和新增活跃均按当前方案绑定的充值金额或有效投注门槛判定，满足任一项即计入，不再使用全局活跃条件。', '关联代理列表、团队代理管理、代理佣金结算和站点佣金方案。', '2026-07-17 16:56：佣金方案新增/修改弹窗去除首充人数和首充额度；层级/星级方案仅保留返佣比例，团队方案绑定活跃会员和新增活跃判定条件，并按百分比展示返佣比例及校验高层级不得低于低层级。', { updatedAt: '2026-07-17 16:56' }),
