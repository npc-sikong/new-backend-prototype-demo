...
const NOTE_SPECS = {
  ...
  negativeProfitReport: {
    ...
    logic: '代理类型统一显示团队代理，代理身份显示官方代理或普通代理，代理层级显示团队负责人、副线或单线代理。团队负责人查看团队汇总并可展开团队负责人及全部副线；副线仅显示本人线路记录，不展示团队汇总、团队负责人或其他副线；单线代理仅显示本人。佣金净收益右侧依次展示本期欠款和总欠款；本期欠款 = MAX(0，-净输赢)，总欠款 = MAX(0，-冲正后净输赢)。页面不展示操作、佣金状态、发放、审核、维护、调整原因或佣金调整字段。',
